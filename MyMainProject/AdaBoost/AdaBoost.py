...
# Вывод: Получил результат абсолютно идентичный градиентному бустингу, но при этом из-за малого кол-ва подбираемых гиперпараметров
# он работает в разы быстрее. 

# Стоит позже проверить работу на различных random_state.