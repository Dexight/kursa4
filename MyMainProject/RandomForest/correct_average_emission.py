...
#Вывод: По сравнению с заменой на среднее значение при учёте значений выбросов улучшились результаты для метода случайного леса.
# Остальные результаты методов никак не изменились.