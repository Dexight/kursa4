...
LogRegr(standardized_features, df['Type'])

#Без подбора гиперпараметров:
#Рeзультат оценки на тестовом наборе данных: 0.7441860465116279
#С подбором гиперпараметров:
#Результат 'лучшей' оценки: 0.6176470588235294
#Результат оценки на тестовом наборе данных: 0.7441860465116279