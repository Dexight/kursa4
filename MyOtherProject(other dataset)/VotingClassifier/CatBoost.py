...
def CatBoost(features, Class, rs):
    print("\n" * 2)
    ...
    classifier = CatBoostClassifier(random_seed=rs, logging_level='Silent') # logging_level - параметр для отладки. Silent - никакого вывода, Verbose - подробный вывод
    ...
    classifier = CatBoostClassifier(random_seed=rs, logging_level='Silent')
